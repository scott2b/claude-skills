---
name: obsidian-api
description: ADVANCED Obsidian operations via REST API. Use ONLY for Dataview queries, periodic notes, or patch operations (insert after heading/block). For standard vault operations (search, read, write), use the 'obsidian' skill instead (4-7x faster).
---
